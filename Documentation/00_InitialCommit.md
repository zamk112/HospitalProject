...
So far it is working and no compilation errors as expected. Now I'm going to test the `weatherforecast` endpoint on the browser and looks like HTTPs version is working.  
...
│  Yes
│
◇  Scaffolding project in /Users/zamk/Projects/HospitalProject/HospitalProject.Client...
│
...
![Launched ReactJS Website](./images/Screenshot%202026-03-06%20at%207.51.17 pm.png)
